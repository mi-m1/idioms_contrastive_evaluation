...
#SBATCH -o literal_flant5xl_1shot.out
...
python hf_1shot.py --model_name google/flan-t5-xl --eval_dataset ../prompting/dataset/literal_1032.csv --model_abr flant5xl --setting literal
