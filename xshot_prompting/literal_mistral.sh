...
#SBATCH -o literal_mistral_1shot.out
...
python mistral_1shot.py --model_name mistralai/Mistral-7B-Instruct-v0.3 --eval_dataset ../prompting/dataset/literal_1032.csv --model_abr mistral7binstructv0.3 --setting literal