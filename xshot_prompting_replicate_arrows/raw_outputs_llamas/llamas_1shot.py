...
# def run_and_save_predictions(idioms, sentence, model, setting):
    ...
    for idiom, sentence in tqdm(idiom_sent_dict):
        ...
        The expression 'play with fire' is used figuratively in the sentence: 'The war took away the unfortunate necessity, as Unionists saw it, to play with fire in the national interest, but it did not materially alter their view of themselves.' → Output: i
        The expression 'play with fire' is used literally in the sentence: 'Despite the danger, he decided to play with fire, poking the embers with a stick.' → Output: l"""
        ...
        prompt1 = f"Is the expression '{idiom}' used figuratively or literally in the sentence: '{sentence}'. Answer 'i' for figurative, 'l' for literal.{oneshot_example}"
