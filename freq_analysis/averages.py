...
def get_average_for_group(group, metric):

    ls = []

    for filename in glob.glob(f"results_average_per_class/{group}_*.csv"):
...
# get_average_for_group("g1", "f1")
# get_average_for_group("g2", "f1")
# get_average_for_group("g3", "f1")
get_average_for_group("g4", "f1")
