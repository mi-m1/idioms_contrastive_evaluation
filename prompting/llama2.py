...
# def run_and_save_predictions(idioms, sentence, model, setting):
    ...
    for idiom, sentence in tqdm(idiom_sent_dict):
        ...
        {"role": "user", "content": f"expression: '{idiom}'\n sentence: '{sentence}' QUESTION: Is the expression figurative or literal? Generate 'output: i' if the idiom is used figuratively, or generate 'output: l' if the expression is used literally. Only generate the letter after 'output: '."},
        ],
        ...
        {"role": "user", "content": f"expression: '{idiom}'\n sentence: '{sentence}' QUESTION: Given a contextual sentence and a expression, tell me if the expression is used figurative or literally. Either generate 'output: i' if figurative, or generate the letter 'output: l' if literal."},
        ],
        ...
        {"role": "user", "content": f"expression: '{idiom}'\n sentence: '{sentence}' QUESTION: Does the expression hold a figurative or literal meaning in the contextual sentence? Generate 'output: i' for figurative meaning, or 'output: l' for literal meaning."},
        ],
