...
#SBATCH -o figurative_flant5xl.out
...
python hf.py --model_name google/flan-t5-xl --eval_dataset dataset/figurative_1032.csv --model_abr flant5xl --setting figurative
