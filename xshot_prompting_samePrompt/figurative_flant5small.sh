...
#SBATCH -o figurative_flant5small_1shot.out
...
python hf_1shot.py --model_name google/flan-t5-small --eval_dataset ../prompting/dataset/figurative_1032.csv --model_abr flant5small --setting figurative
