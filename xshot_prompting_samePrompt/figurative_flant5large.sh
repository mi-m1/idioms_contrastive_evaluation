...
#SBATCH -o figurative_flant5large_1shot.out
...
# python flant5large.py \
# --model "google/flan-t5-xxl" \
# --seed 1234 \
# --eval_dataset "dataset/gpt4_t08_sentences_verifier_annotations_accepted_only.csv" \

python hf_1shot.py --model_name google/flan-t5-large --eval_dataset ../prompting/dataset/figurative_1032.csv --model_abr flant5large --setting figurative
