...
#SBATCH -o figurative_flant5xxl_1shot.out
...
python hf_1shot.py --model_name google/flan-t5-xxl --eval_dataset ../prompting/dataset/figurative_1032.csv --model_abr flant5xxl --setting figurative
