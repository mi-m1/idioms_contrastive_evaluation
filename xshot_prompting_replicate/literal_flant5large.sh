...
#SBATCH -o literal_flant5large.out
...
python hf_1shot.py --model_name google/flan-t5-large --eval_dataset ../prompting/dataset/literal_1032.csv --model_abr flant5large --setting literal
