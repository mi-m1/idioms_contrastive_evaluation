...
save_dict_as_csv(lc_scores, "results_1shot/lc_scores.csv")
save_dict_as_csv(avg_lc, "results_1shot/lc_avg.csv")
save_dict_as_csv(stdev_lc, "results_1shot/lc_stdev.csv")
# save_dict_as_csv()
...
save_dict_as_csv(sc_scores, "results_1shot/sc_scores.csv")
save_dict_as_csv(avg_sc, "results_1shot/sc_avg.csv")
save_dict_as_csv(stdev_sc, "results_1shot/sc_stdev.csv")
